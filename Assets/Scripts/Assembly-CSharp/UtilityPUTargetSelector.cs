...
public class UtilityPUTargetSelector : MonoBehaviour, ICanCollision
{
	private IFindTarget targetFinder;

	[SerializeField]
	private CollisionSetting collisionSetting;

	public readonly List<ICanTakeDmg> TargetsFound;
	...
	public void RemoveTargetDead(int id)
	{
	}
